...
### Color Accessibility & Design Choices

I chose a slate blue color palette (#667eea) very intentionally for accessibility:

**For Color Blindness:**
- Blue is universally distinguishable across all types of color blindness (protanopia, deuteranopia, tritanopia)
- Red-green color blindness (the most common type) has no trouble with blue
- Blue-yellow color blindness can still distinguish slate blue from backgrounds
- I don't rely on color alone - text labels, icons, and borders provide additional context

**For Light Sensitivity (Photophobia) in Dark Mode:**
- I use muted, desaturated backgrounds (#2d3748, #4a5568) instead of pure black or bright colors
- The slate blue is softer than bright neon blues, making it less harsh on sensitive eyes
- No pure white text - I use softer grays (#f7fafc, #e2e8f0) for reduced eye strain
- Reduced contrast compared to pure black/white combinations
- Subtle shadows and glows instead of harsh edges

**Why This Palette Works:**
- High contrast ratios meet WCAG AA standards (4.5:1 for normal text)
- Blue is the safest color choice for accessibility across all visual conditions
- The blues aren't overly saturated or neon
- Neumorphic design with soft shadows reduces eye strain compared to flat, high-contrast designs
- Benefits users with color blindness, light sensitivity, low vision, and astigmatism
